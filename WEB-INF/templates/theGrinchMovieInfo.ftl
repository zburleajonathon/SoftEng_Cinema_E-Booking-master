...
<div class="collapse navbar-collapse" id="navbar12"> <a class="navbar-brand d-none d-md-block" href="#">
  ...
  <div class="py-5">
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <h1 class="display-1">Dr Seuss The Grinch</h1>
        </div>
      </div>
    </div>
  </div>
      ...
      <div class="row">
        <div class="col-md-12 p-3">
          <div class="card box-shadow p-0 m-0">
            <img class="card-img-top" src="resources/images/TheGrinch.jpg" style="	transform:  scale(.8);">
            <div class="card-body">
              <div class="d-flex justify-content-between align-items-center">
                <div class="btn-group">
                  <button onclick="location.href='https://www.youtube.com/watch?v=Bf6D-i8YpHg'" type="button" class="btn btn-sm btn-outline-secondary" contenteditable="true">Play Trailer<br></button>
          ...
          <div class="row">
            <div class="col-md-12">
		    <p class="lead">Runtime: 105 min<br>Rating: PG<br>Genre: Comedy<br>Director: Yarow Cheney<br>Producer: Disney<br>Cast: Benedict Cumberbatch, Cameron Seely, Rashida Jones<br>Synopsis:  A grumpy Grinch plots to ruin Christmas for the village of Whoville. <br><br><button onclick="location.href='https://www.imdb.com/title/tt2709692/externalreviews?ref_=tt_ov_rt'" type="button" class="btn btn-sm btn-outline-secondary">Reviews</button></p>
            </div>
          </div>
        </div>
      </div>
